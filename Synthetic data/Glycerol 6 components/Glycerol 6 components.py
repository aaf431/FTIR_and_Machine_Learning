...
keys = ['Acetic acid','Dihydroxyacetone','Formic acid', 'Glycerol', 'Glycolic acid','Oxalic acid','Water']
...
# Define train set based on n_train
    ...
    if model_type == 'ANN':
        if pca_param is True:
            model =MLPRegressor(hidden_layer_sizes=(20,),tol=1e-5, max_iter=1000, random_state=0,solver = 'lbfgs', 
